      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight pt-35"
          >
          ...
          >
            DevHire connects talented professionals with top companies. Whether
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-blue-600 text-white px-6 py-3 rounded-lg flex items-center gap-2 font-medium"
